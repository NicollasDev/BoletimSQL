...
--Com update sem Where todos os elementos são mudados

-- DELETE - Excluir 

DELETE FROM Aluno WHERE idAluno = 5;

--WHERE É IMPORTANTE POIS ELE É NECESSARIO PARA PODER SELECIONAR APENAS O QUE QUER EXCLUIR OU MUDAR
...
/*CREATE TABLE teste(
CPF VARCHAR(16) UNIQUE NOT NULL,     COM UNIQUE SÓ PODE SE USAR UMA VEZ O VALOR, 
